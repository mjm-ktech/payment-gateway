...
export interface ApiBankAccountBankAccount extends Schema.CollectionType {
  ...
  attributes: {
    ...
    bank: Attribute.Relation<
      ...
      'api::bank.bank'
    >;
    transfer_email: Attribute.String;
    transfer_password: Attribute.String;
...
export interface ApiCheckingHistoryCheckingHistory
  extends Schema.CollectionType {
  collectionName: 'checking_histories';
  info: {
    singularName: 'checking-history';
    pluralName: 'checking-histories';
    displayName: 'Checking history';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    request: Attribute.Relation<
      'api::checking-history.checking-history',
      'oneToOne',
      'api::transfer-request.transfer-request'
    >;
    execution_time: Attribute.Integer;
...
export interface ApiMomoAccountMomoAccount extends Schema.CollectionType {
  collectionName: 'momo_accounts';
  info: {
    singularName: 'momo-account';
    pluralName: 'momo-accounts';
...
export interface ApiTransferRequestTransferRequest
  extends Schema.CollectionType {
  ...
  attributes: {
    ...
    pay_status: Attribute.Boolean & Attribute.DefaultTo<false>;
    content: Attribute.UID<
      undefined,
      undefined,
      {
    ...
    website: Attribute.Relation<
      ...
      'api::website.website'
    >;
    type: Attribute.Enumeration<['Momo', 'VietinBank', 'MBBank', 'Sacombank']>;
    user: Attribute.Relation<
      'api::transfer-request.transfer-request',
      'oneToOne',
      'plugin::users-permissions.user'
...
export interface ApiWebsiteWebsite extends Schema.CollectionType {
  ...
  attributes: {
    ...
    momo_account: Attribute.Relation<
      'api::website.website',
      'oneToOne',
      'api::momo-account.momo-account'
    >;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::checking-history.checking-history': ApiCheckingHistoryCheckingHistory;
      'api::momo-account.momo-account': ApiMomoAccountMomoAccount;
      'api::transfer-request.transfer-request': ApiTransferRequestTransferRequest;
